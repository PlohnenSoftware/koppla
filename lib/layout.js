...
function labelsFromNode(node, font) {
    ...
    if (node.description) {
        const descriptionLabel = makeLabel(node.description, font.width, font.height);
        const placeLongDescriptionLeft = node.description.length > MAX_NODE_LABEL_LENGTH &&
            (node.designator === "V" ||
